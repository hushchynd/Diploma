    ...
    if (options.update===true) {
        $(selector).each(function () {
            ...
            $(selector + '-data').each(async function () {
                ...
                $(selector).prop('files', datr.files)
            ...
            `)
                $('.preview__del').on('click', function (event) {
                    var inputFile = $(this).closest('.preview').siblings(selector)
                    var dt = new DataTransfer();
                    var name = $(this).find('svg').data('name')
            ...
            // }else{
            // let path = $(this).closest('.card-body').find(selector+'-data').data('path');
            // let name = $(this).closest('.card-body').find(selector+'-data').data('name');
            // let size = $(this).closest('.card-body').find(selector+'-data').data('size');
            // const srcToFile = async (src, fileName) => {
            //     const response = await axios.get(src, {
            //         responseType: "blob",
            //     });
